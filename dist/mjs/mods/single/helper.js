...
import { DEFAULT_COOLDOWN, DEFAULT_EXPIRATION, DEFAULT_TIMEOUT } from '../utils/defaults.js';
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.core.mutate(skey, current, function () { return (__assign({ time: time_2, cooldown: cooldown_2, expiration: expiration_2, aborter: undefined, optimistic: false }, state_3)); }, params)];
