import { __awaiter, __generator, __assign, __spreadArray, __read } from '../../../node_modules/tslib/tslib.es6.mjs';
import { lastOf } from '../../libs/arrays.mjs';
import { getTimeFromDelay } from '../../libs/time.mjs';
import { AbortError } from '../errors/abort.mjs';
import { DEFAULT_EQUALS, DEFAULT_COOLDOWN, DEFAULT_EXPIRATION, DEFAULT_TIMEOUT } from '../utils/defaults.mjs';
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 4:
                        ...
                        state_2 = {};
                        if (data !== undefined)
                            state_2.data = __spreadArray(__spreadArray([], __read(((_a = current === null || current === void 0 ? void 0 : current.data) !== null && _a !== void 0 ? _a : [])), false), [data], false);
                        state_2.error = error;
