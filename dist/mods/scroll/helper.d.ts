...
export declare class ScrollHelper {
     ...
     */
    first<D = any, E = any, N extends D = D, K = any>(skey: string | undefined, current: State<D[], E, N[], K> | undefined, scroller: Scroller<D, E, N, K>, fetcher: Fetcher<D, E, N, K>, aborter?: AbortController, params?: Params<D[], E, N[], K>, force?: boolean, ignore?: boolean): Promise<State<D[], E, N[], K> | undefined>;
    /**
