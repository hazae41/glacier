...
function useScroll(scroller, fetcher, cooldown) {
    ...
    var fetch = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core.first(key, scroller, fetcher, cooldown)];
    ...
    var refetch = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core.first(key, scroller, fetcher)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }, [core, key, scroller, fetcher]);
    var scroll = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core.scroll(key, scroller, fetcher)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    }); }, [core, key, scroller, fetcher]);
    ...
    return { key: key, data: data, error: error, time: time, loading: loading, mutate: mutate, fetch: fetch, refetch: refetch, scroll: scroll, clear: clear };
}
