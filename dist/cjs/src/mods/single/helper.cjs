...
var generator = require('../../libs/generator.cjs');
                ...
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        if (data !== undefined)
                            state_1.data = data;
                        state_1.error = error;
                        return [4 /*yield*/, this.core.mutate(skey, current, function () { return (tslib_es6.__assign({ time: time_1, cooldown: cooldown_1, expiration: expiration_1, aborter: undefined }, state_1)); }, params)];
            ...
            return tslib_es6.__generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 3:
                            ...
                            return tslib_es6.__generator(this, function (_l) {
                                switch (_l.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this_1.core.mutate(skey, current, function (c) { return (tslib_es6.__assign({ time: c === null || c === void 0 ? void 0 : c.time, aborter: aborter, optimistic: true }, optimistic)); }, params)];
                                    case 1:
                                        current = _l.sent();
                                        return [2 /*return*/];
                                }
                        ...
                        this_1 = this;
                        generator_1 = tslib_es6.__asyncValues(generator$1);
                        _j.label = 4;
                    ...
                    case 21:
                        ...
                        return [4 /*yield*/, this.core.mutate(skey, current, function () { return (tslib_es6.__assign({ time: time_2, cooldown: cooldown_2, expiration: expiration_2, aborter: undefined, optimistic: false }, state_2)); }, params)];
