...
var SyncLocalStorage = /** @class */ (function () {
    ...
    SyncLocalStorage.prototype.unmount = function () {
        ...
        (function () { return tslib_es6.__awaiter(_this, void 0, void 0, function () { return tslib_es6.__generator(this, function (_a) {
    ...
    SyncLocalStorage.prototype.collect = function () {
        ...
        if (typeof Storage === "undefined")
            return;
        try {
            for (var _b = tslib_es6.__values(this.keys), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
