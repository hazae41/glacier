...
var ortho = require('../libs/ortho.js');
var helper$1 = require('./scroll/helper.js');
var helper = require('./single/helper.js');
var storage = require('./types/storage.js');
...
var Core = /** @class */ (function (_super) {
    ...
    Core.prototype.unmount = function () {
        var e_1, _a;
        try {
            for (var _b = tslib.__values(this.timeouts.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        next = tslib.__assign(tslib.__assign({}, current), state);
                        _c = next;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if ((current === null || current === void 0 ? void 0 : current.expiration) === -1)
                            return [2 /*return*/];
                        erase = function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var count;
                            return tslib.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
