...
var AsyncLocalStorage = /** @class */ (function () {
    ...
    AsyncLocalStorage.prototype.unmount = function () {
        ...
        (function () { return tslib.__awaiter(_this, void 0, void 0, function () { return tslib.__generator(this, function (_a) {
    ...
    AsyncLocalStorage.prototype.collect = function () {
        ...
        if (typeof Storage === "undefined")
            return;
        try {
            for (var _b = tslib.__values(this.keys), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
