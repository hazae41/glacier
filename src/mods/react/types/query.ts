...
export interface Query<K, D, F> extends Omit<QuerySettings<K, D, F>, "time" | "cooldown" | "expiration"> {
   ...
   */
  fetch(aborter?: AbortController): Promise<Result<Result<State<D, F>, FetchError>, CooldownError | MissingFetcherError>>
   ...
   */
  refetch(aborter?: AbortController): Promise<Result<Result<State<D, F>, FetchError>, MissingFetcherError>>
   ...
   */
  suspend(): Promise<Result<Result<State<D, F>, FetchError>, MissingFetcherError>>
